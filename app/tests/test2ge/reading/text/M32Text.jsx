      ...
      >
        ...
        <Box sx={{ marginTop: 2, textAlign: "left", mb: 2 }}>
          <Typography variant="body1" gutterBottom>
            The Fortescue Neighbourhood Action Group is urging residents to
            attend a public meeting to hear the concerns of local residents and
            families of pupils from Fortescue Primary School about the approval
            of the final stage of the M32 motorway.
          </Typography>
          <Typography variant="body1" gutterBottom>
          ...
          >
            ...
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
              <b>Location: </b>Jarrah Community Hall, corner of Fortescue Road
              and Huxley Parade, Fortescue.
            </Typography>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
          ...
          <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
            Community organisations successfully lobbied for more dedicated
            parks and for noise restrictions in Zone 1. The developers, BD
            Construction, acted on this due to objections from the community. We
          ...
          <ul>
            <li>
              <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
                ...
                and birds in the area moved (or were moved by conservation
                groups) from Zone 1 to Zone 2. Now that Zone 2 is to be
                developed, no policy exists to assist these animals; they have
                little chance of finding an appropriate habitat nearby.
              </Typography>
            </li>
            <li>
              <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
            ...
            <li>
              <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
                The Environmental Impact Statement put out by BD Construction
                for Stage 3 does not specifically address the issue of noise and
        ...
        <Box sx={{ marginTop: 2, textAlign: "left" }}>
          ...
          >
            ...
            Hamperdown Avenue will be transformed into an outdoor eatery. Come
            and sample delicacies from nearby restaurants including Georgio's
            Pizza, Al Basha Kebab House and Texas Fry-Up. Lively bands,
            including international act Firehouse will entertain throughout the
            day.
          ...
          >
            ...
            Come and see students from East Concorde Middle School show you
            their moves!
            <br />
            Main Stage
          </Typography>
          ...
          >
            ...
            Joss and Bill, along with other graduates from the Concorde School
            of Music, will entertain throughout the day. Pets welcome.
          </Typography>
          <Typography
            variant="body1"
            gutterBottom
