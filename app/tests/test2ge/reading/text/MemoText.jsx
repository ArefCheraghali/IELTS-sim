    ...
    <Box sx={{ userSelect: "text" }}>
      ...
      <Box sx={{ marginTop: 2, textAlign: "left", mb: 2 }}>
        <Typography variant="body1" gutterBottom>
          Head office is stream lining procedures for the safety and security of
          employees, cash and stock. Below is the procedure for closing the
          Vern's Clothing Warehouse. Please follow these steps in all branches.
        </Typography>
        ...
        >
          ...
          <Typography variant="body2" gutterBottom sx={{ mb: "10px" }}>
            - Lock the automatic door (main entry) by pushing the red button to
        ...
        >
          ...
          <Typography variant="body2" gutterBottom sx={{ mb: "10px" }}>
            ...
            people who might be able to view the activity from outside the store
            through windows. The back office is the best place for counting
            money.
          </Typography>
          <Typography variant="body2" gutterBottom sx={{ mb: "10px" }}>
          ...
          <Typography variant="body2" gutterBottom sx={{ mb: "10px" }}>
            - Two people must always be present when the safe is open and money
            is being counted, so always do this in the presence of a co-worker.
          </Typography>
          <Typography variant="body2" gutterBottom sx={{ mb: "10px" }}>
            - Leave register drawers open to better protect point of sale
            terminals in the event of a break-in because burglars are likely to
            damage a register if trying to gain access.
          </Typography>
          <Typography variant="body2" gutterBottom sx={{ mb: "10px" }}>
      ...
      <Box sx={{ marginTop: 2, textAlign: "left" }}>
        ...
        <ul>
          <li>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
              ...
              issued with a burgundy Heritage Hotel jacket, to be worn with the
              regulation black skirt or trousers, also provided by the Hotel.
            </Typography>
          </li>
          <li>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
              Those working back-of-house in maintenance and housekeeping roles
              will be provided with two white Bob Charles shirts with the Hotel
              insignia on the front. Trousers or a skirt in navy blue will also
              be issued by the Hotel.
            </Typography>
          </li>
          <li>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
        ...
        <ul>
          <li>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
              The hotel issues complete uniforms to all staff, which are signed
              for on commencement of employment and must be returned when
              leaving the company.
            </Typography>
          </li>
          <li>
          ...
          <li>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
              Those working as managers or at reception may store their uniform
              in the locker in the office to the rear of reception and keep the
              jacket there during the shift if it is not being worn. It can be
              laundered when necessary in the hotel laundry.
            </Typography>
          </li>
          <li>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
              Those working in maintenance and housekeeping may also have their
              uniform laundered. Uniforms can be placed in the laundry basket in
              the ground-floor staffroom and picked up from the shelf in the
              same room for the next shift. It must be recorded on the wall
              chart when an item is dropped off or collected.
            </Typography>
          </li>
          <li>
            <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
              If the management / reception uniform is torn, please take it
              directly to Ms Nichols in the laundry. Maintenance / housekeeping
              staff should notify their team leader if their uniform needs
