      ...
      >
        ...
        <Box sx={{ marginTop: 2, textAlign: "left", mb: 2 }}>
          ...
          <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
            ...
            these stairs are inaccessible, use the nearest alternative
            staircase. Do not use the lifts. Do not run.
          </Typography>
          <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
            6. Each class, under the teacher’s supervision, will move in a
            brisk, orderly fashion to the paved quadrangle area adjacent to the
            car park.
          </Typography>
          <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
          ...
          <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
            ...
            and she will be waiting there with the master timetable and staff
            list in her possession.
          </Typography>
          <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
          ...
          <Typography variant="body1" gutterBottom sx={{ mb: "10px" }}>
            11. The Supervisor will inform the Office when all staff and
        ...
        <Box sx={{ marginTop: 2, textAlign: "left" }}>
          ...
          <Typography variant="body1" gutterBottom>
            Gain foundation knowledge for employment in an accounts position
            with bookkeeping and business basics through to intermediate level;
          ...
          <Typography variant="body1" gutterBottom>
            ...
            technologies are available and how they can benefit your
            organisation.
            <br /> Code B/ED033
