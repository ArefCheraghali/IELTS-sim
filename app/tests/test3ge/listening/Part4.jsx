...
const Part4 = ({ answers, setAnswers }) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ width: "100%", display: "flex", flexDirection: "row", mb: 4 }}>
        <Box
          sx={{
            width: "100%",
            height: "auto",
        ...
        >
          ...
          <Typography sx={{ mt: 3 }}>
            <TextField
              ...
              value={answers[30]}
            />
            . The Caveman diet is a popular example. This diet includes foods
            such as lean
          </Typography>
          <Typography sx={{ mt: 3 }}>
      ...
      >
        <FormControl sx={{ mt: 1 }}>
          <Typography>
            <b style={{ marginRight: "2em" }}>35</b> Research evidence suggests
            that ...
          </Typography>
          <RadioGroup
            sx={{ ml: "5em" }}
        ...
        <FormControl sx={{ mt: 2 }}>
          <Typography>
            <b style={{ marginRight: "2em" }}>36</b> Thai people have difficulty
            digesting milk because ...
          </Typography>
          <RadioGroup
            sx={{ ml: "5em" }}
            value={answers[35] || ""}
        ...
        >
          <List sx={{ listStyleType: "disc", ml: "3em" }}>
            ...
            <ListItem sx={{ display: "list-item" }}>
              <Typography>Jains – vegetarian, but milk is permitted</Typography>
            </ListItem>
